...
d3.csv("SmartHouse.csv", function(data) {
...
var width = 80,
    height = 180,
    maxTemp = d3.max(data, function(d) { return +d.TempDespacho; }),
    minTemp = d3.min(data, function(d) { return +d.TempDespacho; }),
    currentTemp = d3.mean(data, function(d) { return +d.TempDespacho; });
